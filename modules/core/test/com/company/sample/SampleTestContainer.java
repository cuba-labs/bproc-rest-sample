...
public class SampleTestContainer extends TestContainer {
    ...
    public SampleTestContainer() {
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/sample/test-app.properties");
        autoConfigureDataSource();
    }

    

    public static class Common extends SampleTestContainer {

        public static final SampleTestContainer.Common INSTANCE = new SampleTestContainer.Common();
